    ...
    if (req.method === 'POST') {
        ...
        form.parse(req, async (err, fields, files) => {
            ...
            try {
                ...
                let [err1] = await _(s3.upload({ ...params, ContentType: categoryImage.mimetype!, Body: fs.createReadStream(categoryImage.filepath), Key: 'product-category-image/' + categoryImageFileName }).promise());
                if (err1) {
